...
import { SearchDrinkByFilterProps } from "./types";

import { useCategory } from "../../hooks/useCategory";
import { CategoryDrinkType } from "../Category/types";

import { SearchDrinkByFilterContainer, SearchDrinkByFilterForm } from "./styles";
import { useDrink } from "../../hooks/useDrink";
import { Button } from "../Button";
import { useIngredient } from "../../hooks/useIngredient";
import { DrinkInput } from "../DrinkInput";

export function SearchDrinkByFilter({ categories = [], ingredients = [], filterTitle }: SearchDrinkByFilterProps) {
    ...
    <SearchDrinkByFilterContainer>
      ...
      <SearchDrinkByFilterForm onSubmit={handleSubmit}>
        <label>
          ...
          <select value={chosenFilter} onChange={(event) => handleCategoryChange(event)}>
            <option value=''>Select an option</option>
            {filterTitle === 'category' ? categories.map(category => (
              <option 
